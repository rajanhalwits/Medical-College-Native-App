                ...
                <View>
                    <TouchableOpacity activeOpacity={0.8} style={styles.blueBtn} onPress={()=>saveToCameraRoll(jobData.document)}>
                        <Text style={styles.btnText}>
                            <View>
                            <Image source={require('./../../assets/job_description/downlog_bt.png')} style={{ width: 14, height: 14, marginRight: 5 }} />
                            </View>Download
                        </Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={styles.blueBtn} onPress={() => sendWhatsApp()}>
                        <Text style={styles.btnText}>
                            <View>
                                <Image source={require('./../../assets/job_description/whatspp.png')} style={{ width: 20, height: 20, marginRight:5 }} />
                            </View>
