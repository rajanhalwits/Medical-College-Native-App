...
import {
  ...
  TouchableOpacity, ScrollView, Platform, Pressable, Alert, AsyncStorage, ActivityIndicator, Dimensions
} from 'react-native';
          ...
          <View style={{ width: '35%', marginLeft: '2%' }}>
            <TouchableOpacity onPress={() => setGender('2')} style={gender == '2' ? styles.uploadBtn : styles.genderBtn}>
              <Text style={gender == '2' ? styles.btnTextActive : styles.genderText}>
                {
                  gender == '2' ?
                    <View><Image source={require(`./../../assets/get_started/female.png`)} style={{ width: 20, height: 17 }} /></View>
                    :
                    <View><Image source={require(`./../../assets/get_started/female_grey.png`)} style={{ width: 20, height: 17 }} /></View>
                }
                Female</Text>
            </TouchableOpacity>
          </View>
...

{
        ...
        <View>
            {
              ...
              <View>
                ...
                <Picker selectedValue={selectedCountry} style={styles.pickerStyle} itemStyle={styles.pickerOpt}
                  onValueChange={(itemValue, itemIndex) => 
              ...
              <View>
                ...
                {Platform.OS =='android' ? <Image source={require('./../../assets/country.png')} style={styles.inputImg} /> : null}
              </View>
            }
          </View>
          {
             ...
             <View>
              ...
              <Picker selectedValue={selectedState} style={styles.pickerStyle} itemStyle={styles.pickerOpt}
                onValueChange={(itemValue, itemIndex) => 
                  fetchCity(itemValue)
                }>
          ...
          {Platform.OS =='android' ?<Image source={require('./../../assets/state.png')} style={styles.inputImg} /> : null}
          {
            Platform.OS =='ios' ?
            ...
            <View>
             ...
             <Picker selectedValue={selectedCity} style={styles.pickerStyle} itemStyle={styles.pickerOpt}
               onValueChange={(itemValue, itemIndex) => 
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={{ width: '49.5%', marginLeft: '1%' }}>
            <TouchableOpacity activeOpacity={0.8} style={styles.uploadBtn} onPress={()=>setShowCamera(!showCamera)}>
      ...
      :
      Platform.OS =='ios' ?
          <View style={{flex:1, backgroundColor:'pink',  position:'absolute', zIndex:99, top:20, left:0, right:0, height:windowHeight-20}}>
            <TouchableOpacity activeOpacity={0.8} style={styles.uploadBtn} onPress={flipCamera}>
          ...
          <Camera
              ...
              ratio={'1:1'}
            />
            <TouchableOpacity activeOpacity={0.8} style={styles.uploadBtn} onPress={takePicture}>
              <Text style={styles.btnText}><Image source={require('./../../assets/add-camera.png')}
                style={{ width: 20, height: 17 }} /> Camera</Text>
            </TouchableOpacity>
          </View>
          ...
          <Camera
            ...
            <TouchableOpacity activeOpacity={0.8} style={styles.uploadBtn} onPress={takePicture}>
              <Text style={styles.btnText}><Image source={require('./../../assets/add-camera.png')}
                style={{ width: 20, height: 17 }} /> Capture</Text>
            </TouchableOpacity>
          </View>
      }
