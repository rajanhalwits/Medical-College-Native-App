    ...
    <ScrollView style={{ backgroundColor: '#FAFBFF' }}>
      ...
      <View style={{ paddingLeft: 15, paddingRight: 15, marginTop: 10 }}>
        ...
        <View style={{ flexDirection: 'row', marginTop: 25, marginBottom: 25 }}>
          <View style={{ width: '35%' }}>
            <TouchableOpacity onPress={() => setGender('male')} style={gender == 'male' ? styles.uploadBtn : styles.genderBtn}>
              <Text style={gender == 'male' ? styles.btnTextActive : styles.btnText}>
                {
                  gender == 'male' ?
          ...
          <View style={{ width: '35%', marginLeft: '2%' }}>
            <TouchableOpacity onPress={() => setGender('female')} style={gender == 'female' ? styles.uploadBtn : styles.genderBtn}>
              <Text style={gender == 'female' ? styles.btnTextActive : styles.btnText}>
                {
                  gender == 'female' ?
