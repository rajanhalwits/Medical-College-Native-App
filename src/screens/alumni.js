...
import { View, Text, StyleSheet, Image, FlatList, Linking, TouchableOpacity, Platform, TextInput, Alert, AsyncStorage, ScrollView } from 'react-native'
                        ...
                        <View>
            {
              ...
              <View>
                ...
                <View style={styles.selectBox}>
                    ...
                    <Picker selectedValue={selectedCountry} style={styles.pickerItem} onValueChange={(itemValue) =>fetchState(itemValue)}>
                        <Picker.Item label='Select Country' value='' />
                        {
                            countryList.length > 0 ?
                            countryList.map((country) =>
            ...
            <View>
              ...
              null
          }
                {
                    ...
                    <View style={{paddingVertical:20, marginTop:15, marginBottom:20}}>
